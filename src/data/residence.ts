 ...
 * while keeping the public coordinate at city-level precision. The displayed
 * district label is descriptive only and does not imply a precise residence
 * marker. All browser-facing images are same-origin so MapLibre markers can
...
export const residence = {
  ...
  mapImageAlt: '北京区域级地图静态回退，不表示具体居住位置',
